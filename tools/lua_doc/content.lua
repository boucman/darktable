...
types.dt_iop_module_so_t:set_text([[Generic information on an IOP]]):add_version_info("IOP support added")
types.dt_iop_module_so_t.has_blending:set_text("does that IOP allow blending")
types.dt_iop_module_so_t.in_group_effect:set_text("Is the IOP in the effect group")
types.dt_iop_module_so_t.id:set_text("unique string identifying the IOP")
types.dt_iop_module_so_t.deprecated:set_text("is the IOP deprectaded")
types.dt_iop_module_so_t.in_styles:set_text("is the IOP saved in styles")
types.dt_iop_module_so_t.in_group_color:set_text("is the IOP in the color group")
types.dt_iop_module_so_t.in_history:set_text("is the IOP displayed in history")
types.dt_iop_module_so_t.in_group_correct:set_text("is the IOP in the effect group")
types.dt_iop_module_so_t.in_group_basic:set_text("is the IOP in the basic group")
types.dt_iop_module_so_t.hidden:set_text("is the IOP hidden")
types.dt_iop_module_so_t.version:set_text("the internal version number for that IOP")
types.dt_iop_module_so_t.has_masks:set_text("is this IOP compatible with masks")
types.dt_iop_module_so_t.name:set_text("translated name of the IOP")
types.dt_iop_module_so_t.in_group_tone:set_text("is the IOP in the tone group")
